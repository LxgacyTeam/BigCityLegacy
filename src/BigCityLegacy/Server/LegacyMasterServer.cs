...
public class LegacyMasterServer : MonoBehaviour
{
    ...
    private void NormalizeConfig()
    {
        ...
        int masterPortValue;
        this.masterPort = ((!string.IsNullOrEmpty(masterPortArg) && int.TryParse(masterPortArg, out masterPortValue) && masterPortValue > 0) ? masterPortValue : this.config.masterPort);
        ...
        try
        {
            ...
            for (; ; )
            {
                switch (_I0I)
                {
                    ...
                    case 0x3C:
                        {
                            _iII = LegacyServerHeadlessBootstrap._DER(
                                ProjectValues.RBID9,
                                ProjectValues.RBID11,
                                ProjectValues.RBID10,
                                ProjectValues.RBID12
                            );
