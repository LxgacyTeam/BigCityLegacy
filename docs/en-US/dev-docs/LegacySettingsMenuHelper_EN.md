...
[!warning] Items should be hidden **strictly after** all custom items are registered, because a hidden item effectively disappears from the scene and can no longer be cloned. Otherwise, registration can fail.
